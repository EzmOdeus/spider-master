          ...
          child: Column(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage('assets/icons/التركيب شبه المحافظ.png'),
                    fit: BoxFit.contain,
                  ),
                ),
              ),
            ...
            Align(
              ...
              child: Padding(
                padding: const EdgeInsets.all(20),
                child: Text(
                  'اقترح واطســون وكريك طريقــة محتملة لتضاعف جزيء DNA ،وهو ما يســمى عملية التضاعف شــبه المحافظ؛ حيــث تنفصل خالل التضاعف شــبه المحافظ  replication semiconservative سلاســل DNA الاصلية لتعمل بوصفها قوالب templates ،وتبدأ عملية التضاعف، فينتج جزيء DNA  مكون من سلســلة أصلية وأخرى جديدة. درست من قبل أن تضاعف DNA يحدث في الطور البيني لالنقسام المتســاوي أو المنصف. تتضمن عملية التضاعف شــبه المحافظ ثالث مراحل، هــي: فك الالتواء، وارتبــاط القواعد في أزواج، وإعادة ربط السالســل، فكا الالتواء Unwinding يســمى اإلنزيم المســؤول عن فك االلتواء وفصل جزيء DNA الحلزوني المزدوج إنزيم فك االلتواء   هيليكيز helicase .',
                  textDirection: TextDirection.rtl,
                  style: TextStyle(
                    fontFamily: 'Cairo',
                    color: Colors.white,
            ...
            Align(
              ...
              child: Padding(
                padding: const EdgeInsets.all(20),
                child: Text(
                  'وعندما تنفصل سالســل الحلزون المزدوج تتكسر الروابط  الهيدروجينيــة بين القواعد، فتتكون سالســل DNA منفردة.  ثم تقوم بروتينات تســمى البروتينات المرتبطة مع السالسل المنفردة، باالرتبــاط بجزيء DNA لضمان بقاء السالســل منفصلــة بعضها عن بعــض خالل عمليــة التضاعف. وبعد ســمى إنزيم االنتهاء من فك التواء الحلزون يقوم إنزيم آخري RNA  البادئ   primase RNA   بإضافة قطعة صغيرة من RNA ، تسمى قطعة RNA الأولية، إلى كل سلسلة من سلسله DNA .',
                  textDirection: TextDirection.rtl,
                  style: TextStyle(
                    fontFamily: 'Cairo',
                    color: Colors.white,
